...
// Variables can be defined inline as well.
const { data } = await createProjectMember({ projectId: ..., });
...
// Variables can be defined inline as well.
const ref = createProjectMemberRef({ projectId: ..., });
...
// Variables can be defined inline as well.
const { data } = await deleteProjectMember({ id: ..., });
...
// Variables can be defined inline as well.
const ref = deleteProjectMemberRef({ id: ..., });
