...
## CreateProjectMember
You can execute the `CreateProjectMember` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useCreateProjectMember(options?: useDataConnectMutationOptions<CreateProjectMemberData, FirebaseError, CreateProjectMemberVariables>): UseDataConnectMutationResult<CreateProjectMemberData, CreateProjectMemberVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCreateProjectMember(dc: DataConnect, options?: useDataConnectMutationOptions<CreateProjectMemberData, FirebaseError, CreateProjectMemberVariables>): UseDataConnectMutationResult<CreateProjectMemberData, CreateProjectMemberVariables>;
```
...
```
### Return Type
Recall that calling the `CreateProjectMember` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `CreateProjectMember` Mutation is of type `CreateProjectMemberData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateProjectMember`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, CreateProjectMemberVariables } from '@dataconnect/generated';
import { useCreateProjectMember } from '@dataconnect/generated/react'

export default function CreateProjectMemberComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useCreateProjectMember();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useCreateProjectMember(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useCreateProjectMember(options);
  ...
  const mutation = useCreateProjectMember(dataConnect, options);

  // After calling the Mutation hook function, you must call `UseMutationResult.mutate()` to execute the Mutation.
  // The `useCreateProjectMember` Mutation requires an argument of type `CreateProjectMemberVariables`:
  const createProjectMemberVars: CreateProjectMemberVariables = {
    projectId: ..., 
  };
  mutation.mutate(createProjectMemberVars);
  // Variables can be defined inline as well.
  ...
  mutation.mutate(createProjectMemberVars, options);
...
## DeleteProjectMember
You can execute the `DeleteProjectMember` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useDeleteProjectMember(options?: useDataConnectMutationOptions<DeleteProjectMemberData, FirebaseError, DeleteProjectMemberVariables>): UseDataConnectMutationResult<DeleteProjectMemberData, DeleteProjectMemberVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useDeleteProjectMember(dc: DataConnect, options?: useDataConnectMutationOptions<DeleteProjectMemberData, FirebaseError, DeleteProjectMemberVariables>): UseDataConnectMutationResult<DeleteProjectMemberData, DeleteProjectMemberVariables>;
```
...
```
### Return Type
Recall that calling the `DeleteProjectMember` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `DeleteProjectMember` Mutation is of type `DeleteProjectMemberData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `DeleteProjectMember`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, DeleteProjectMemberVariables } from '@dataconnect/generated';
import { useDeleteProjectMember } from '@dataconnect/generated/react'

export default function DeleteProjectMemberComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useDeleteProjectMember();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useDeleteProjectMember(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useDeleteProjectMember(options);
  ...
  const mutation = useDeleteProjectMember(dataConnect, options);

  // After calling the Mutation hook function, you must call `UseMutationResult.mutate()` to execute the Mutation.
  // The `useDeleteProjectMember` Mutation requires an argument of type `DeleteProjectMemberVariables`:
  const deleteProjectMemberVars: DeleteProjectMemberVariables = {
    id: ..., 
  };
  mutation.mutate(deleteProjectMemberVars);
  // Variables can be defined inline as well.
  mutation.mutate({ id: ..., });
  ...
  mutation.mutate(deleteProjectMemberVars, options);
