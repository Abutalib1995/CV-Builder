import { createUserRef, updateUserRef, getUserRef, createProjectRef, updateProjectRef, deleteProjectRef, getProjectRef, listProjectsRef, createTaskRef, updateTaskRef, deleteTaskRef, getTaskRef, listTasksRef, createProjectMemberRef, deleteProjectMemberRef, listProjectMembersRef, createCommentRef, deleteCommentRef, listCommentsRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useCreateProjectMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
export function useDeleteProjectMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
